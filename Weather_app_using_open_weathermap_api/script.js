...
function getWeatherData() {
    navigator.geolocation.getCurrentPosition((success) => {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitute}&exclude=hourly,minutely&units=metric&appid=${API_KEY}`).then(res => res.json()).then(data => {
